...
CREATE VIEW citations_with_officer_location
AS
    SELECT
        c.Ticket_Number,
        o.Badge_Number,
...
CREATE VIEW violation_summary_by_type
AS
    SELECT
        v.Violation_Code,
...
CREATE VIEW citation_violation_joined
AS
    SELECT
        c.Ticket_Number,
        v.Violation_Code,
...
CREATE VIEW above_avg_fine_violations
AS
    SELECT DISTINCT
        Violation_Code,
...
CREATE VIEW payments_by_vehicle_type
AS
    SELECT
        v.Vehicle_Type,
